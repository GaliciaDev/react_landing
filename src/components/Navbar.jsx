...
const Navbar = () => {
    ...
    border-neutral-700/80">
        ...
        <div className="container px-4 mx-auto relative text-sm">
            ...
            <div className="hidden lg:flex justify-center space-x-12 items-center"> {/* Boton de iniciar sesion */}
            ...
            {mobileDrawerOpen && (
                ...
                flex flex-col justify-center items-center lg:hidden">
                    ...
                    <div className="flex space-x-6">
                        ...
                        <a href="" className="bg-gradient-to-r from-orange-500 to bg-orange-800
                        py-2 px-3 rounded-md">
                            Create Account
                        </a>
                    </div>
